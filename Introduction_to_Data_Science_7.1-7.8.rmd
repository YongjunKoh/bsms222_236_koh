...
(Image courtesy of RStudio[^3]. CC-BY-4.0 license[^4].)

[^3]: https://github.com/rstudio/cheatsheets
[^4]: https://github.com/rstudio/cheatsheets/blob/master/LICENSE
...
## 7.6 lobal versus local aesthetic mappings
