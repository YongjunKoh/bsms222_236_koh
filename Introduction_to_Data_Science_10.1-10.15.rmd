...
![](https://rafalab.github.io/dsbook/book_files/figure-html/piechart-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/donutchart-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/two-barplots-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/excel-barplot-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/dataviz/img/class2_8.jpg){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/barplot-from-zero-1-1.png){width=70%}

Here is another example, described in detail in a Flowing Data blog post:

![](https://rafalab.github.io/dsbook/dataviz/img/Bush-cuts.png){width=70%}

(Source: Fox News, via Flowing Data.)

This plot makes a 13% increase look like a five fold change. Here is the appropriate plot:

![](https://rafalab.github.io/dsbook/book_files/figure-html/barplot-from-zero-2-1.png){width=70%}

Finally, here is an extreme example that makes a very small difference of under 2% look like a 10-100 fold change:

![](https://rafalab.github.io/dsbook/dataviz/img/venezuela-election.png){width=70%}

(Source: Venezolana de Televisión via Pakistan Today and Diego Mariano.)

Here is the appropriate plot:

![](https://rafalab.github.io/dsbook/book_files/figure-html/barplot-from-zero-3-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/points-plot-not-from-zero-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/dataviz/img/state-of-the-union.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/area-not-radius-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/do-not-order-alphabetically-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/reorder-boxplot-example-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/show-data-1-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/common-axes-histograms-wrong-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/common-axes-histograms-right-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/show-the-data-comparison-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/no-transformations-wrong-use-of-barplot-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/no-transformation-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/correct-transformation-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/boxplots-not-adjacent-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/boxplot-adjacent-comps-1.png){width=70%}

### 10.6.5 Use color

The comparison becomes even easier to make if we use color to denote the two things we want to compare:

![](https://rafalab.github.io/dsbook/book_files/figure-html/boxplot-adjacent-comps-with-color-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/color-blind-friendly-colors-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/scatter-plot-instead-of-slope-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/encoding-third-variable-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/available-shapes-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/dataviz/img/fig8b.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/colors-for-different-lines-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/dataviz/img/fig2d.png){width=70%}
...
Q2. What is the problem with the plot below:

![](https://rafalab.github.io/dsbook/book_files/figure-html/baplot-not-from-zero-exercises-1.png){width=70%}
...
Q3. Take a look at the following two plots. They show the same information: 1928 rates of measles across the 50 states.

![](https://rafalab.github.io/dsbook/book_files/figure-html/measels-exercise-1.png){width=70%}
...
Q4. To make the plot on the left, we have to reorder the levels of the states’ variables.
...
Q5. Now with one line of code, define the `dat` table as done above, but change the use mutate to create a rate variable and re-order the state variable so that the levels are re-ordered by this variable. Then make a barplot using the code above, but for this new `dat`.

```{r}
dat <- dat %>% mutate(rate = count / population * 10000 * 52 / weeks_reporting, state = reorder(state, rate))
...
Q6. Say we are interested in comparing gun homicide rates across regions of the US. We see this plot:
...
Q7. Make a boxplot of the murder rates defined as
...
Q8. The plots below show three continuous variables.

![](https://rafalab.github.io/dsbook/book_files/figure-html/pseudo-3d-exercise-1.png){width=70%}
...
Q1. Reproduce the image plot we previously made but for smallpox. For this plot, do not include years in which cases were not reported in 10 or more weeks.
...
Q2. Now reproduce the time series plot we previously made, but this time following the instructions of the previous question.
...
dat2 %>% 
  ...
  ggtitle("Cases per 10,000 by state") + 
  xlab("") + ylab("") +
  geom_text(data = data.frame(x = 1938, y = 2.5), 
            mapping = aes(x, y, label="US average"), 
            color="black")
```

Q3. For the state of California, make time series plots showing rates for all diseases. Include only years with 10 or more weeks reporting. Use a different color for each disease.
...
us_contagious_diseases %>%
  ...
  filter(!is.na(rate)) %>%
  ggplot() +
  geom_line(aes(year, rate, color = disease), alpha = 0.5, size = 1) +
  scale_y_continuous(trans = "sqrt") + 
  ggtitle("Cases per 10,000 by state") + 
  xlab("") + ylab("") + labs(color="Disease")
```


Q4. Now do the same for the rates for the US. Hint: compute the US rate by using summarize, the total divided by total population.
...
us_contagious_diseases %>%
  ...
  ggplot() +
  geom_line(aes(year, us_rate, color = disease), alpha = 0.5, size = 1) +
  scale_y_continuous(trans = "sqrt") + 
  ggtitle("Cases per 10,000 US average") + 
  xlab("") + ylab("") + labs(color="Disease")
```
