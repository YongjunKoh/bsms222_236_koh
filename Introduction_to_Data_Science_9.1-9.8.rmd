...
![](https://rafalab.github.io/dsbook/book_files/figure-html/boxplot-dont-show-bimodal-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/income-west-v-devel-before-after-ratio-1.png){width=70%}
...
p + geom_density(alpha = 0.2) + 
  facet_grid(year ~ .)
```
 we want the densities to be smoother, we use the `bw` argument so that the same bandwidth is used in each density. We selected 0.75 after trying out several values.
```{r}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/income-smooth-density-counts-by-region-year-weighted-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/ecological-fallacy-averages-1.png){width=70%}
...
![](https://rafalab.github.io/dsbook/book_files/figure-html/ecological-fallacy-all-data-1.png){width=70%}
